    ...
    if(isset($_POST['user']) && isset($_POST['pass'])){
        ...
        $check = mysqli_num_rows($query);
                ...
                if($check >= 1){
                        ...
                        if(strlen($pass) < 8){
                                $err="Mật khẩu phải lớn hơn 8 kí tự";
                        }
                        else{
                                $pass = md5($pass);
                                $sql = "UPDATE user_account SET user_password = '$pass' WHERE maso='$user'";
                                $query = mysqli_query($conn,$sql);
...
<body>
    ...
    <div class="container" style="display:flex">
        ...
        <span class="word">Đổi mật khẩu tài khoản sinh viên <?= $data['ten'] ?></span>
    </div>
    <br>
    <br>
    <div class="container framechangepass">
        <form class="formchangepass" action="" method="POST">
                <div class="thediv" style="display:flex">
                        <span> Mã Số Sinh Viên &emsp;&emsp;&emsp;</span>
